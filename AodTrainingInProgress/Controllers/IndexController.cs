...
{
    public class IndexController(SqliteConfig sqliteConfig, IUserService<UserV1> userService) : Controller
    {
        protected string _accountRequiredMessage = "account is required.";
        protected string _accountNotExistMessage = "account does not exist.";
